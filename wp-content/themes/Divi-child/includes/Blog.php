	...
	public function render( $attrs, $content, $render_slug ) {
		...
		if ( have_posts() ) {
			...
			<article id="post-<?php the_ID(); ?>" <?php post_class( 'et_pb_post clearfix' . $no_thumb_class . $overlay_class . $item_class ); ?>>
				...
				<!-- get player custom field podcast_audio -->
				<?php $podcast_url = get_post_meta( get_the_ID(), 'podcast_audio', true ); 
				if ( $podcast_url ) { ?>
					<div class="podcast-player">
						<audio controls>
							<source src="<?php echo $podcast_url; ?>" type="audio/mpeg">
						</audio>
					</div>
				<?php } ?>
				<!-- end get player custom field podcast_audio -->
